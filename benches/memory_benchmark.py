...
def run_benchmarks():
    ...
    print(f"""
{'Operation':<20} {'Library':<10} {'Time (ms)':<12} {'Memory (MB)':<12} {'CPU (s)':<10}
{'-'*64}
{'dumps':<20} {'rjson':<10} {rjson_dumps['avg_time_ms']:<12.2f} {rjson_dumps['peak_memory_mb']:<12.2f} {rjson_dumps['cpu_time_s']:<10.4f}
{'dumps':<20} {'orjson':<10} {orjson_dumps['avg_time_ms']:<12.2f} {orjson_dumps['peak_memory_mb']:<12.2f} {orjson_dumps['cpu_time_s']:<10.4f}
{'dumps':<20} {'json':<10} {json_dumps['avg_time_ms']:<12.2f} {json_dumps['peak_memory_mb']:<12.2f} {json_dumps['cpu_time_s']:<10.4f}
{'-'*64}
{'loads':<20} {'rjson':<10} {rjson_loads['avg_time_ms']:<12.2f} {rjson_loads['peak_memory_mb']:<12.2f} {rjson_loads['cpu_time_s']:<10.4f}
{'loads':<20} {'orjson':<10} {orjson_loads['avg_time_ms']:<12.2f} {orjson_loads['peak_memory_mb']:<12.2f} {orjson_loads['cpu_time_s']:<10.4f}
{'loads':<20} {'json':<10} {json_loads['avg_time_ms']:<12.2f} {json_loads['peak_memory_mb']:<12.2f} {json_loads['cpu_time_s']:<10.4f}
""")
